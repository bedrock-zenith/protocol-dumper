...
export class ArrayInformation extends PrimitiveTypeInformation {
   ...
   public override getLayoutData(data: object): void {
      ...
      if (this.vector_length !== null)
         Reflect.set(data, "vector_dimension", this.vector_length);
   ...
   public override consumeInternal(context: Context, consumer: Consumer): void {
      ...
      if (minItems.hasValue())
         Reflect.set(this.metadata, "min_length", minItems.extract("number"));

      if (maxItems.hasValue())
         Reflect.set(this.metadata, "max_length", maxItems.extract("number"));
